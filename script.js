...
var I18N = {
  fr: {
    ...
    "edu.title": "Éducation",
    "edu.1.m": "2024 – 2026",
    "edu.1.t": "Diplôme d'Ingénieur en Génie Logiciel (DIT)",
    "edu.1.s": "École Supérieure Polytechnique de Dakar",
    "edu.2.m": "Mai 2025 – Mars 2026",
    "edu.3.m": "Nov. 2025",
    "edu.3.t": "Titre de qualification — Développeur Web & Mobile",
    "edu.3.s": "Simplon × ONFP, Sénégal",
    "edu.4.m": "2022 – 2024",
    "edu.4.t": "Diplôme de Technicien Supérieur en Informatique",
    "edu.4.s": "École Supérieure Polytechnique de Dakar",
    "cert.eyebrow": "Certifications",
    "cert.title": "11 certifications",
    "c.1": "Data Engineer Certificate — DataCamp",
    "c.1d": "Mai 2025 – Mars 2026",
    "c.3d": "Nov. 2025",
    "c.4d": "Oct. 2025",
    "c.5d": "Déc. 2025",
    "c.6d": "Déc. 2025",
    "c.7d": "Déc. 2025",
    "c.8": "Network Equipment & Basic Configuration — Cisco",
    "c.8d": "Déc. 2025",
    "c.9d": "Fév. 2026",
    "c.10d": "Mars 2026",
    "c.11d": "Fév. 2026",
    ...
    "xp.2.role": "Stagiaire en Science des Données — iSHEERO",
    "xp.2.desc": "Création d'outils automatisés pour analyser de grandes quantités de données et en extraire des tendances exploitables. Mise en place de modèles capables de prédire des comportements et de repérer des anomalies dans les données. Conception de tableaux de bord visuels pour permettre aux décideurs de comprendre les résultats sans compétence technique.",
    "xp.3.meta": "Sep. 2024 – Oct. 2024 · Stage",
    "xp.3.role": "Développeur — Banque de l'Habitat du Sénégal",
    "xp.3.desc": "Développement d'une application de gestion bancaire fiable, utilisée pour le suivi des opérations internes. Livraison de 100 % de la documentation, assurant la continuité du projet après mon départ.",
    "xp.4.meta": "Mai 2024 – Juil. 2024 · Stage",
    "xp.4.role": "Stagiaire en Ingénierie des Données — Université Cheikh Anta Diop (UCAD)",
    "xp.4.desc": "Comparaison de 5+ modèles d'IA pour identifier les plus performants en termes de rapidité, coût et fiabilité. Mise en place d'un processus automatisé de nettoyage de données, réduisant le temps de préparation de ~40 %. Rédaction de rapports de veille sur les dernières avancées en intelligence artificielle.",
    "xp.5.meta": "Mai 2023 – Juil. 2023 · Stage",
    "xp.5.role": "Stagiaire en Ingénierie Logicielle — LITA",
    "xp.5.desc": "Participation au développement de logiciels en équipe, avec relecture de code et documentation des livrables.",
    ...
    "nav.contact": "Contact",
    "hero.sub": "Ingénieur logiciel et praticien en science des données, diplômé de l'École Supérieure Polytechnique de Dakar. Je conçois des applications web de bout en bout — du pipeline de données au déploiement — et j'aime particulièrement les sujets où l'IA sert à résoudre un problème concret : prédiction de tendances, surveillance de réseaux, détection d'objets. Je travaille en équipe, je documente ce que je livre, et je m'implique sur les projets à impact, notamment en santé publique.",
    ...
    "exp.ia": "Spring AI + Claude API, orchestration d'agents autonomes, LLM, NLP, computer vision (YOLO), détection d'anomalies, pipelines data en Python. Dans mes projets, l'IA n'est pas un gadget : elle résout un problème métier précis, de l'extraction de données jusqu'à la mise en production.",
    "proj.eyebrow": "Projets personnels",
    "proj.title": "Du prototype IA à la prod",
    "p.ecommerce": "Boutique e-commerce mode & artisanat africain (Next.js) : catalogue produits, panier, paiement Dexpay Africa.",
    "p.styleflow": "Plateforme de réservation de salons de coiffure et barbershops à Dakar : avis, tarifs et disponibilités en ligne.",
    "p.vision": "Application de reconnaissance visuelle en temps réel, capable d'identifier des objets via une caméra.",
    "p.cyber": "Outil de surveillance réseau capable de détecter des menaces et d'envoyer des alertes en temps réel.",
    "p.ids": "Système de détection d'intrusion intelligent qui analyse le trafic réseau pour identifier les attaques.",
    ...
    "proj.orchestrator": "Plateforme SaaS permettant de piloter plusieurs agents IA autonomes pour exécuter des tâches complexes en chaîne.",
  ...
  en: {
    ...
    "edu.title": "Education",
    "edu.1.m": "2024 – 2026",
    "edu.1.t": "Engineer's Degree in Software Engineering (DIT)",
    "edu.1.s": "École Supérieure Polytechnique de Dakar",
    "edu.2.m": "May 2025 – Mar. 2026",
    "edu.3.m": "Nov. 2025",
    "edu.3.t": "Qualification Title — Web & Mobile Developer",
    "edu.3.s": "Simplon × ONFP, Senegal",
    "edu.4.m": "2022 – 2024",
    "edu.4.t": "Higher Technician Diploma in Computer Science",
    "edu.4.s": "École Supérieure Polytechnique de Dakar",
    "cert.eyebrow": "Certifications",
    "cert.title": "11 certifications",
    "c.1": "Data Engineer Certificate — DataCamp",
    "c.1d": "May 2025 – Mar. 2026",
    "c.3d": "Nov. 2025",
    "c.4d": "Oct. 2025",
    "c.5d": "Dec. 2025",
    "c.6d": "Dec. 2025",
    ...
    "xp.1.meta": "May 2026 – Present · Freelance / Hybrid",
    "xp.1.role": "Full Stack Developer — Consortium Araignée SAS",
    "xp.1.desc": "Designed and delivered custom web applications for clients in construction, universities and internal management, enabling them to run their daily operations. Built large-scale management platforms: construction site tracking, university administration, business tools tailored to each client. Wrote technical documentation to ease onboarding and maintenance of delivered tools.",
    "xp.2.meta": "Apr. 2026 – May 2026 · Internship · Remote",
    "xp.2.role": "Stagiaire en Science des Données — iSHEERO",
    "xp.2.desc": "Created automated tools to analyse large datasets and extract actionable trends. Built models capable of predicting behaviours and spotting anomalies in data. Designed visual dashboards to help decision-makers understand results without technical expertise.",
    "xp.3.meta": "Sep. 2024 – Oct. 2024 · Internship",
    "xp.3.role": "Developer — Banque de l'Habitat du Sénégal",
    "xp.3.desc": "Developed a reliable banking management application used for tracking internal operations. Delivered 100% of the documentation, ensuring project continuity after my departure.",
    "xp.4.meta": "May 2024 – Jul. 2024 · Internship",
    "xp.4.role": "Stagiaire en Ingénierie des Données — Université Cheikh Anta Diop (UCAD)",
    "xp.4.desc": "Compared 5+ AI models to identify the best performers in terms of speed, cost and reliability. Set up an automated data cleaning process, reducing preparation time by ~40%. Wrote research reports on the latest advances in artificial intelligence.",
    "xp.5.meta": "May 2023 – Jul. 2023 · Internship",
    "xp.5.role": "Stagiaire en Ingénierie Logicielle — LITA",
    "xp.5.desc": "Contributed to team software development with code reviews and documentation of deliverables.",
    ...
    "nav.contact": "Contact",
    "hero.sub": "Software Engineer and Data Science practitioner, graduated from the École Supérieure Polytechnique de Dakar. Experienced in data processing, artificial intelligence and web application development. I have designed and delivered concrete tools: trend prediction, automated network monitoring, visual object detection. Detail-oriented, strong communicator, comfortable working in teams. Driven by high-impact projects, especially in public health.",
    ...
    "p.ecommerce": "African fashion & craft e-commerce store (Next.js): product catalogue, cart, Dexpay Africa payment.",
    "p.styleflow": "Booking platform for hair salons and barbershops in Dakar: reviews, prices and online availability.",
    "p.vision": "Real-time visual recognition application, capable of identifying objects via a camera.",
    "p.cyber": "Network monitoring tool capable of detecting threats and sending real-time alerts.",
    "p.ids": "Intelligent intrusion detection system that analyses network traffic to identify attacks.",
    ...
    "proj.orchestrator": "SaaS platform enabling the orchestration of multiple autonomous AI agents to execute complex chained tasks.",
...
function initThree() {
  ...
  var renderer = new THREE.WebGLRenderer({
    canvas: canvas,
    antialias: !isMobile,            // AA coûteux sur GPU mobile
    alpha: true,
  ...
  /* ---- Vue d'ensemble ---- */
  if (isMobile) {
    board.scale.setScalar(0.78);   // la carte tient dans un écran étroit
  }

  /* ---- Caméra : points de passage ---- */
  var camState = {
    x: 0, y: 3.2, z: isMobile ? 13.5 : 11.5,
    tx: 0, ty: 0.4, tz: 0
  };
  function applyCam() {
  ...
  function render() {
    ...
    if (!prefersReducedMotion && !isMobile) {
      // légère respiration du plateau — désactivée sur mobile (batterie)
      idleSpin.v += dt * 0.12;
      board.rotation.y = board.userData.scrollY + Math.sin(idleSpin.v) * 0.03;
    } else {
      board.rotation.y = board.userData.scrollY;
    }
  ...
  var tl = gsap.timeline({
    ...
    scrollTrigger: {
      ...
      start: "top top",
      /* L'assemblage atteint 100 % quand le haut de la section contact
         arrive aux 3/4 de l'écran : le panneau I/O se pose pendant que
         la carte est encore pleinement visible, avant que le fond
         sombre du contact ne la recouvre. */
      endTrigger: "#contact",
      end: "top 75%",
      scrub: 1.2,
