...
var I18N = {
  fr: {
    ...
    "nav.contact": "Contact",
    "hero.sub": "Ingénieur Logiciel et praticien en Science des Données, diplômé de l'École Supérieure Polytechnique de Dakar. Expérimenté dans le traitement de données, l'intelligence artificielle et le développement d'applications web. J'ai conçu et livré des outils concrets : prédiction de tendances, surveillance automatique de réseaux, détection visuelle d'objets. Rigoureux, bon communicant, à l'aise en équipe. Motivé par les projets à impact, notamment en santé publique.",
