...
var I18N = {
  fr: {
    ...
    "nav.contact": "Contact",
    "hero.eyebrow": "Dakar, Sénégal — disponible freelance",
    "hero.sub": "Développeur Full-Stack — Java / Spring Boot, React / TypeScript, DevOps & IA. Freelance et étudiant ingénieur à l'ESP Dakar / UCAD, passionné par les agents IA, le machine learning et les architectures propres.",
    ...
    "contact.sub": "Un projet web, une API, un pipeline data ou un agent IA à mettre en production ? Je réponds vite.",
  ...
  en: {
    ...
    "nav.contact": "Contact",
    "hero.eyebrow": "Dakar, Senegal — available for freelance",
    "hero.sub": "Full-Stack Developer — Java / Spring Boot, React / TypeScript, DevOps & AI. Freelancer and engineering student at ESP Dakar / UCAD, passionate about AI agents, machine learning and clean architectures.",
    ...
    "contact.sub": "A web project, an API, a data pipeline or an AI agent to ship to production? I answer fast.",
...
function initThree() {
  ...
  /* ---- Reveals de contenu ---- */
  gsap.utils.toArray(
    ".section-card, .project, .section-head, .contact-card, .projects-more"
  ).forEach(function (el) {
